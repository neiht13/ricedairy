...
const IconSquareRotated: FC<IconSquareRotatedProps> = ({ className,color }) => {
    return (
        <svg width="15" height="15" viewBox="0 0 30 30" fill={color} xmlns="http://www.w3.org/2000/svg"  className={className}>
            <path
