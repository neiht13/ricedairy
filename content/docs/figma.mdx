...
<AspectRatio ratio={16 / 9} className="w-full mt-4">
  <iframe
    src="https://embed.figma.com/file/1203061493325953101/hf_embed?community_viewer=true&embed_host=thein&hub_file_id=1203061493325953101&kind=&viewer=1"
    className="h-full w-full overflow-hidden rounded-xl border bg-muted"
  />
</AspectRatio>
