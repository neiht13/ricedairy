...
// @ts-ignore
		createMuavu({...values,
			soluong: parseFloat(values.soluong),
			dientich: parseFloat(values.dientich), ngaybatdau: dayjs(date).format("DD/MM/YYYY"), user: session?.user?.username || ""
		})
	}
		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel>Diện tích xuống giống (Ha) </FormLabel>
							<FormControl>
