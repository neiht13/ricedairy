...
export default function Header() {
  ...
  return (
    <header className="bg-green-800 text-white fixed top-0 left-0 w-full z-50 shadow-md">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <Button variant="outline" className="text-white border-white hover:bg-green-700 transition-colors duration-200">
              Get Started
            </Button>
          </div> */}
      ...
      {/* Menu di động */}
      <div 
        className={`md:hidden px-4 py-2 bg-green-700 transition-transform duration-300 ease-in-out ${
