            ...
            types.map((type, stageIndex) => (
              <div key={type} className="mb-12">
                ...
                <div className="flex justify-center mb-6">
                  <span className="z-20 px-4 py-2 bg-yellow-600 text-white rounded-full text-sm font-semibold capitalize">
                ...
                {groupedItems[type].map((item, index) => (
                  ...
                  >
                    ...
                    <div className="z-20 flex items-center order-1 bg-yellow-600 shadow-xl w-8 h-8 rounded-full">
