                  ...
                  <Tooltip key={theme.name}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={cn(
                          "flex h-11 w-9 items-center justify-center rounded-xl border-2 text-xs",
                          isActive
                      ...
                      >
                        <span
                          className={cn(
                            "flex h-6 w-6 items-center justify-center rounded-xl bg-[--theme-primary]"
                          )}
                        >
                          {isActive && (
  ...
  return (
    <ThemeWrapper defaultTheme="zinc" className="relative space-y-4">
      <div data-rehype-pretty-code-fragment="">
        <pre className="max-h-[450px] overflow-x-auto rounded-xl border bg-zinc-950 py-4 dark:bg-zinc-900">
